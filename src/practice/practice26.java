...
//				break;
	...
	public static void level2() {
		...
		*/
		...
		//System.out.print("목적지 층수 입력(2~100) : ");
		System.out.println("목적지 층수 목록(2~100) : ");
		for(int i=0; i<destFloorArr.length; i++) {
		...
		System.out.print("탑승객 몸무게 목록(40~15) : ");
		...
		System.out.print("엘리베이터총 무게(kg) 입력 : ");
		...
		*/
		...
		// 탑승정원 -> 무게 필터
		// weightArr.lenght > maxPersonCount
		/*
