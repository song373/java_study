...
public class Variable03 {
	...
	public static void main(String[] args) {
		...
		double result1 = i6 + d6;   //int + doublue --> double
		System.out.println(result1);
		
		
		// int    = double
		//int result 2 = i6 + d6; // int + double
		...
		// 소수점이 정확하게 결과로 나오게 하기 위해ㅛㅓ
		// 연산을 double 과 int  의 연산으로 바꾼다
		// int 값 한게 or 두개 모두를 (double) 실수형으로 강제타입변환
		z =(double)x / y;  // double / int -> double
		z = x / (double)y; // int / double -> double
		z = x / (double)x / (double)y;  // double / double -> double
		System.out.println(z);
